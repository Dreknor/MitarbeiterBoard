...
class StoreOxTerminRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('create calendar events');
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'beschreibung.max'      => 'Die Beschreibung darf maximal 5000 Zeichen lang sein.',
            'rrule.max'             => 'Die Wiederholungsregel ist zu lang.',
        ];
    }
}
