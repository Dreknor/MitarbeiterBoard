    ...
    private function buildLayoutConfig($request): array
    {
        return [
            ...
            'spalten' => [
                ...
                'kontrolliert'                => $request->input('col_kontrolliert', '12') . '%',
                ...
                'label_trennung_unterschrift' => $request->boolean('label_trennung_unterschrift', false),
                'label_trennung_kontrolliert' => $request->boolean('label_trennung_kontrolliert', false),
            ],
            'header' => [
