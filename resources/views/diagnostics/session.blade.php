                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            @if($session->is_completed)
                                ...
                                @endcan
                            @else
                                <form action="{{ route('diagnostic.complete', $session->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    <button type="submit" class="btn btn-success" onclick="return confirm('Session abschließen? Sie können danach keine Änderungen mehr vornehmen.')">
